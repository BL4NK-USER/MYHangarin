...
"""
from hangarin.views import HomePageView, TaskList, TaskCreateView, TaskUpdateView, TaskDeleteView, SubTaskList, SubTaskCreateView, SubTaskUpdateView, \
SubTaskDeleteView, NoteList, NoteCreateView, NoteUpdateView, NoteDeleteView, PriorityList, PriorityCreateView, PriorityUpdateView, PriorityDeleteView, \
